...
<div id="tb" style="padding:2px 5px;position:relative;">
	...
	<form name="form1"  action="" method="post" enctype="multipart/form-data" >
			<input name=stuExcel " type="file" style="display: inline"/> <input type="button" value="导入"  onclick="doImportExcel()"/>
			<input type="button" value="导出模板"  onclick="doExportExcel()"/>
	</form>
	<form action="" id="search" method="post" style="position:absolute; right:0; top:1">
		学号：<s:textfield name="student.student_id" id="student_id"  cssStyle="width:160px;" />
        ...
        $(function(){
     	...
     	//导入用户
      	function doImportExcel(){
      		document.forms[0].action = "${pageContext.request.contextPath }/student/student_importExcel";
