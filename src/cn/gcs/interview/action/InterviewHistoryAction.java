...
@Component
@Scope("prototype")
public class InterviewHistoryAction extends ActionSupport {
	@Autowired
	...
	public String execute() throws Exception {
		...
		result = interviewService.getOldInterview(page, rows);
		total = interviewService.getTotalNumberOfOldInterview();
		return SUCCESS;
	}
